...
const ISSUES = [
  {
    key: "ears",
    msg: "Make sure both ears are visible",
    tip: "Move hair behind ears and face camera directly",
  },
  {
    key: "lighting",
    msg: "Improve lighting on your face",
    tip: "Face a natural light source, avoid strong backlight",
  },
  {
    key: "far",
    msg: "Move closer to the camera",
    tip: "Keep your face within the oval frame",
  },
  {
    key: "eyes",
    msg: "Please keep your eyes open and visible",
    tip: "Avoid squinting, look directly at camera",
  },
  {
    key: "tilt",
    msg: "Center your face in the frame",
    tip: "Hold your head straight and look directly ahead",
  },
];
...
const CHALLENGES = [
  {
    ...
    hint: "Close and open both eyes once slowly",
    emoji: "👁️",
  },
  {
    id: "turn",
    label: "Turn your head slightly to the left",
    hint: "Keep your face within the oval frame",
    emoji: "↩️",
  },
  {
    id: "smile",
    label: "Smile naturally",
    hint: "A gentle natural smile works best",
    emoji: "😊",
  },
];
...
function useCamera(videoRef) {
  ...
  useEffect(() => {
    ...
    navigator.mediaDevices
      ...
      .catch((err) => {
        if (active)
          setCamErr(err.name === "NotAllowedError" ? "denied" : "error");
      });
...
function CameraOverlay({ state, chIdx }) {
  ...
  const scanning = [S.INIT, S.NO_FACE, S.PARTIAL, S.VALID, S.LIVENESS].includes(
    state,
  );
      ...
      >
        ...
        >
          ...
          <motion.ellipse
            ...
            animate={{
              stroke: color,
              strokeDashoffset: scanning ? [0, -88] : 0,
            }}
            transition={{
              stroke: { duration: 0.3 },
              strokeDashoffset: {
        ...
        {state === S.VALID && (
          ...
          >
            ...
            <p className="text-sm font-semibold text-primary-dark">
              Face detected — preparing liveness check
            </p>
          </motion.div>
        )}
          ...
          >
            ...
            <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
              <motion.div
                ...
                style={{
                  background: "linear-gradient(90deg, #60BB46, #22C55E)",
                }}
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #60BB46 0%, #22C55E 100%)",
                }}
              >
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              {["Face Match", "Liveness", "Anti-Spoof"].map((label) => (
                <div
                  key={label}
                  className="bg-primary/5 border border-primary/10 rounded-xl p-2.5 text-center"
                >
                  <CheckCircle2
                    size={15}
                    className="text-primary mx-auto mb-1"
                  />
                  <p className="text-[10px] font-bold text-primary-dark leading-tight">
                    {label}
                  </p>
                </div>
              ))}
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-text-gray leading-relaxed">
                  ...
                  reload. Face verification requires your front camera.
                </p>
              </div>
            </div>
      ...
      <div className="bg-white border-b border-slate-100 px-4 h-14 flex items-center justify-between sticky top-0 z-20">
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-none">
            ...
            <span className="block text-[10px] font-semibold text-text-gray tracking-wide">
              Assistant
            </span>
          </div>
        </div>
