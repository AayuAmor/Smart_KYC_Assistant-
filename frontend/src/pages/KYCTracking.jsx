...
const TIMELINE = [
  {
    ...
    desc: "Your document has been received.",
    Icon: Upload,
    color: "#60BB46",
    bg: "#EBF7E6",
  },
  {
    key: "ocr",
    label: "OCR Completed",
    desc: "AI extracted your details successfully.",
    Icon: Search,
    color: "#3B82F6",
    bg: "#EFF6FF",
  },
  {
    key: "started",
    label: "Under Review",
    desc: "Our team is reviewing your application.",
    Icon: Clock,
    color: "#F59E0B",
    bg: "#FFF7ED",
  },
  ...
  },
  {
    key: "approved",
    label: "Approved",
    desc: "KYC fully verified — you're all set!",
    Icon: CheckCircle2,
    color: "#22C55E",
    bg: "#F0FDF4",
  },
      ...
      <div className="max-w-[480px] mx-auto px-4 py-5 space-y-4">
        ...
        {kycId && (
          <div className="bg-white border border-slate-100 rounded-2xl px-4 py-3 flex items-center justify-between shadow-sm">
            ...
            <span className="text-xs font-mono font-bold text-text-dark tracking-wide">
              {kycId}
            </span>
          </div>
        )}
            ...
            <div className="flex items-center gap-5">
              <div className="relative w-20 h-20 shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span className="text-[9px] font-semibold text-text-gray">
                    Done
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-red-600 mt-0.5">
                  Action required to complete KYC
                </p>
              </div>
            </div>
            <p className="text-sm text-red-700 leading-relaxed">
              {rejectionReason ||
                "The uploaded image was blurry or details could not be read clearly. Please upload a clearer image."}
            </p>
            <button
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
          <h3 className="text-sm font-bold text-text-dark mb-5">
            Verification Steps
          </h3>
          <div>
            {TIMELINE.map((item, i) => {
        ...
        {kycStatus !== "approved" && kycStatus !== "rejected" && (
          <div className="flex items-center gap-3 bg-primary/5 border border-primary/15 rounded-2xl px-4 py-3.5">
            ...
            <span className="ml-auto text-sm font-black text-primary shrink-0">
              10–15 min
            </span>
          </div>
        )}
        ...
        >
          ...
          <div className="text-left flex-1">
            ...
            <p className="text-xs text-text-gray">
              Get answers about your KYC status
            </p>
          </div>
